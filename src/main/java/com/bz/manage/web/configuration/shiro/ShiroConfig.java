...
import com.bz.manage.web.filter.shiro.AuthenticationFilter;
import com.bz.manage.web.filter.shiro.KickoutSessionControlFilter;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/system/admin/loginout", "anon");
		// 验证码配置
