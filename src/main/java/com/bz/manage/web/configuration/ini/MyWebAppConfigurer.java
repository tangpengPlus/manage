package com.bz.manage.web.configuration.ini;
...
import com.bz.manage.web.interceptor.system.PaginationInterceptor;
import com.bz.manage.web.interceptor.system.SystemLogRecordInterceptor;
/**
 * 
 * 作者:唐鹏
 * 描述: Spring Mvc 基础配置
