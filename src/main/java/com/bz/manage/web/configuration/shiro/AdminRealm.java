package com.bz.manage.web.configuration.shiro;
...
import com.bz.manage.service.system.AuthorityService;
import com.bz.manage.service.system.EncryptionService;
...
public class AdminRealm extends AuthorizingRealm{
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		if(admin.getState()!=null&&admin.getState().intValue()==1){
			...
			throw new DisabledAccountException("登录失败：登录账户【"+username+"】被限制登录");
		}
         /*验证管理员数据*/
