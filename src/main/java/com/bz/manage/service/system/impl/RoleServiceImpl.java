...
import com.bz.manage.core.constant.message.AlertMessage;
import com.bz.manage.core.util.base.GenerateNumber;
import com.bz.manage.core.util.system.AdminShiroUtil;
import com.bz.manage.dao.base.BaseMapper;
import com.bz.manage.dao.sys.ManageAuthorityMapper;
import com.bz.manage.dao.sys.ManageMenuMapper;
import com.bz.manage.dao.sys.ManageRoleMapper;
import com.bz.manage.model.system.ManageAdmin;
import com.bz.manage.model.system.ManageAuthority;
import com.bz.manage.model.system.ManageMenu;
import com.bz.manage.model.system.ManageRole;
...
private ManageMenuMapper manageMenuMapper;
	...
	public ManageRole selectManageRoleInfoById(Integer roleId) throws Exception {
		...
		List<ManageMenu> menulist=manageMenuMapper.selectCurrYLoginAdminMenu(admin.getId());
		//获取当前角色的权限信息
		List<ManageAuthority> authorlist=manageAuthorityMapper.selectManageAuthorityByAdminId(admin.getId());
