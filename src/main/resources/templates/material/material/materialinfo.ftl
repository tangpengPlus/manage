                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post">
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">手机素材名称</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "material.name",'class="form-control"'/]
                                      </div>
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">手机素材存放地址</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "material.url",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">手机素材显示地址</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "material.place",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                   		     <span>用户名必须是字母、数字、下划线、横杠组成的最小6位最多12位的字符！</span>
                                            [@spring.showErrors /]
                                  ...
                                  <div class="form-group last">
                                          <label class="control-label col-md-3">手机素材图片</label>
                                          <div>
                                   ...
                                   [@spring.formInput "material.id", "", "hidden"/]
