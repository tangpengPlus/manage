                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-4">
                                      [@spring.formInput "cate.name",'class="form-control"'/]
                                      </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-4">
                                      [@spring.formInput "cate.url",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                            [@spring.showErrors /]
                                      </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-4">
                                      [@spring.formInput "cate.place",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                            [@spring.showErrors /]
                                      </div>	
                                 ...
                                 <div class="form-group last">
                                   ...
                                   [@spring.formInput "cate.id", "", "hidden"/]
