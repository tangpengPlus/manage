                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post">
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">热门图片名称</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "hottype.name",'class="form-control"'/]
                                      </div>
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">热门图片存放地址</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "hottype.url",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">热门显示地址</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "hottype.place",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                            [@spring.showErrors /]
                                      </div>	
                                 ...
                                 <div class="form-group last">
                                          <label class="control-label col-md-3">热门图片上传</label>
                                          <div>
                                   ...
                                   [@spring.formInput "hottype.id", "", "hidden"/]
