                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post">
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">美食商品图片名称</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "flowerAndPet.name",'class="form-control"'/]
                                      </div>
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">美食商品图片存放地址</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "flowerAndPet.url",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                            [@spring.showErrors /]
                                      </div>
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">美食商品显示地址</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "flowerAndPet.place",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                            [@spring.showErrors /]
                                      </div>	
                                 ...
                                 <div class="form-group last">
                                          <label class="control-label col-md-3">美食商品图片上传</label>
                                          <div>
                                          ...
                                          <div class="col-md-9" id="phoneset.logo">
                                              <div class="fileupload fileupload-new" data-provides="fileupload">
                                                  <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                      <img src="${flowerAndPet.picture}" alt="" />
                                                  </div>
                                   ...
                                   [@spring.formInput "flowerAndPet.id", "", "hidden"/]
