                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post">
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">首页图片名称</label>
                                      <div class="col-sm-4">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">首页图片存放地址</label>
                                      <div class="col-sm-4">
                                 ...
                                 <div class="form-group last">
                                          <label class="control-label col-md-3">首页图片上传</label>
                                          <div>
