                  ...
                  <div class="panel-body">
                      <div class="adv-table editable-table ">
                          ...
                          [@shiro.hasPermission name="/system/authority/add"]
                              <div class="btn-group">
                                  <a id="editable-sample_new" class="btn btn-primary" href="${base}/material/discountgoods/add">
                                  ...
                                  [#if sharelist?? ]
	                                  [#list sharelist as ph]
	                                   <tr>
	                                      ...
	                                      <td class="numeric">
	                                       [@shiro.hasPermission name="/system/authority/update"]<a type="button" href="${base}/material/discountgoods/update?id=${ph.id}" class="btn btn-danger btn-sm"><i class="icon-refresh"></i> Update</a>[/@shiro.hasPermission]
	                                      &nbsp;&nbsp;[@shiro.hasPermission name="/system/authority/delete"]<a type="button" href="${base}/material/discountgoods/delete?id=${ph.id}" class="btn btn-warning btn-sm"><i class=" icon-trash"></i> Delete</a>[/@shiro.hasPermission]
	                                      </td>
	                                  </tr>
	                                  [/#list]
                                  [/#if]
