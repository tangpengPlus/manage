                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-4">
                                      [@spring.formInput "phoneset.name",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                   		    <span>此设置为手机网站名称，请谨慎填写！</span>
                                            [@spring.showErrors /]
                                      </div>
                                  </div>
                                  
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">手机网站标题</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "phoneset.logoname",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                   		    <span>请填写你的网站标题</span>
                                            [@spring.showErrors /]
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">手机网站关键字</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "phoneset.keyword",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                   		    <span>关键字必须中文是字母组成的字符集！</span>
                                            [@spring.showErrors /]
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">手机网站描述</label>
                                      <div class="col-sm-4">
                                      [@spring.formTextarea "phoneset.describe",'class="form-control" rows=10' /]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                   		    <span>此处为描述你的手机商城</span>
                                            [@spring.showErrors /]
                                      </div>
                                  </div>
                                  
                                   <!--[@spring.formInput "phoneset.id", "", "hidden"/]-->
                                   <div class="form-group last">
                                          <label class="control-label col-md-3">手机网站logo</label>
                                          <div>
