                  ...
                  <div class="panel-body">
                      <div class="adv-table editable-table ">
                          ...
                          [@shiro.hasPermission name="/system/authority/add"]
                              <div class="btn-group">
                                  <a id="editable-sample_new" class="btn btn-primary" href="${base}/material/adultclothing/add">
                     ...
                     <div style="float:left">
                                      查询 :<select id="my_multi_select1" name="maid" style="width:100px">
                                          [#if phoidexliset ??]
                                            [#list phoidexliset as ma]
                                            		[#assign choseState=0/]
                                            			[#list ma.id as id]
                                            				[#if id==ma.id]
                                            					[#assign choseState=1/]
                                  ...
                                  [#if phoidexliset?? ]
	                                  [#list phoidexliset as ph]
	                                   <tr>
	                                      ...
	                                      <td class="numeric">
	                                       [@shiro.hasPermission name="/system/authority/update"]<a type="button" href="${base}/material/adultclothing/update?id=${ph.id}" class="btn btn-danger btn-sm"><i class="icon-refresh"></i> Update</a>[/@shiro.hasPermission]
	                                      &nbsp;&nbsp;[@shiro.hasPermission name="/system/authority/delete"]<a type="button" href="${base}/material/adultclothing/delete?id=${ph.id}" class="btn btn-warning btn-sm"><i class=" icon-trash"></i> Delete</a>[/@shiro.hasPermission]
	                                      </td>
	                                  </tr>
	                                  [/#list]
                                  [/#if]
