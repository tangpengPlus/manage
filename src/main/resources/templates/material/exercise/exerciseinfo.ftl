                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post">
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">户外商品图片名称</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "exercise.name",'class="form-control"'/]
                                      </div>
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">户外商品图片存放地址</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "exercise.url",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                            [@spring.showErrors /]
                                      </div>
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">户外商品显示地址</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "exercise.place",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                            [@spring.showErrors /]
                                      </div>	
                                 ...
                                 <div class="form-group last">
                                          <label class="control-label col-md-3">户外商品图片上传</label>
                                          <div>
                                   ...
                                   [@spring.formInput "exercise.id", "", "hidden"/]
