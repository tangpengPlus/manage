                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-4">
                                      [@spring.formInput "motherhood.name",'class="form-control"'/]
                                      </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-4">
                                      [@spring.formInput "motherhood.url",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                            [@spring.showErrors /]
                                      </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-4">
                                      [@spring.formInput "motherhood.place",'class="form-control"'/]
                                      </div>
                                       <div class="col-sm-4 messageTip">
                                            [@spring.showErrors /]
                                      </div>	
                                 ...
                                 <div class="form-group last">
                                          ...
                                          <div class="col-md-9" id="phoneset.logo">
                                              <div class="fileupload fileupload-new" data-provides="fileupload">
                                                  <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                      <img src="${motherhood.picture}" alt="" />
                                                  </div>
                                   ...
                                   [@spring.formInput "motherhood.id", "", "hidden"/]
