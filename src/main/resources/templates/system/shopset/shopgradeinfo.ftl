                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-4">
                                      [@spring.formInput "addgrade.gradeName",'class="form-control"'/]
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">允许发布商品数:</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "addgrade.allowAmount",'class="form-control"'/]
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">上传空间大小(MB):</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "addgrade.uploadSize",'class="form-control"'/]
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">可选模板套数:</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "addgrade.modelAmount",'class="form-control"'/]
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">收费标准:</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "addgrade.chargeStandard",'class="form-control"'/]
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">需要审核:</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "addgrade.isAudit",'class="form-control"'/]
                                      </div>
                                  </div>
                                   <div class="form-group">
