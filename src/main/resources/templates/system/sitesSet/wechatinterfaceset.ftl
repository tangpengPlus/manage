                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">接口配置URL:</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "interfaceset.setUrl",'class="form-control"'/]
                                      </div>
                                  </div>
                                  
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">接口配置Token:</label>
                                      <div class="col-sm-4">
                                      [@spring.formInput "interfaceset.setTolen",'class="form-control"'/]
                                      </div>
                                  </div>
