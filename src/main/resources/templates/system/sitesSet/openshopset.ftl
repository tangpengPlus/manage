                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post">
                                  ...
                                  <div class="form-group">
                                       ...
                                       <div class="form-group">
                              			<label class="col-sm-2 col-sm-2 control-label">允许申请开店:</label>
                              			<div class="col-sm-4 text-center">
                                        [@spring.formRadioButtons "shopset.applyOpenId" ,send1,'','checked="checked"'/]
                                		[@spring.formRadioButtons "shopset.applyOpenId" ,send2,'','class="radiobtn"'/]
                                       </div>
